document.addEventListener("DOMContentLoaded", function() {
    ...
    const searchModal = document.getElementById('reservation-search-modal');
    const searchResultsBody = document.getElementById('reservation-search-body');
